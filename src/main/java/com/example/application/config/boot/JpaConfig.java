package com.example.application.config.boot;
...
@Configuration
@EnableJpaRepositories(basePackages = {"com.example.infrastructure", "com.example.infrastructure.impl"}, repositoryImplementationPostfix="Impl") 
