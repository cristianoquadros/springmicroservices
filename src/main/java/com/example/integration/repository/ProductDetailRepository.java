...
public interface ProductDetailRepository extends PagingAndSortingRepository<ProductDetail, String> {
    ...
    ProductDetail findByShortDescriptionAndLongDescription(String shortDescription, String longDescription);
    
    ProductDetail findByLongDescription(String longDescription);    
}